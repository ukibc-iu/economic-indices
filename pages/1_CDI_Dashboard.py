...
.bg-1 { background-color: rgba(0, 153, 255, 0.3); }    /* Neon Blue */
.bg-2 { background-color: rgba(102, 255, 102, 0.3); }  /* Bright Lime */
.bg-3 { background-color: rgba(255, 102, 0, 0.3); }    /* Vivid Orange */
</style>
